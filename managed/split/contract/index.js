...
class _MerkleTreePathEntry_0 {
  ...
  toValue(value_0) {
    return _descriptor_7.toValue(value_0.sibling).concat(_descriptor_1.toValue(value_0.goes_left));
  }
}
...
class _Either_1 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_16.alignment().concat(_descriptor_5.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.is_left).concat(_descriptor_16.toValue(value_0.left).concat(_descriptor_5.toValue(value_0.right)));
  }
}
...
export class Contract {
    ...
    this.circuits = {
      deposit: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(amount_0).concat(_descriptor_2.toValue(root_0)),
      ...
      claim: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const participantId_0 = args_1[1];
        const recipient_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claim',
                                     'argument 1 (as invoked from Typescript)',
                                     'split.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(participantId_0).concat(_descriptor_5.toValue(recipient_0)),
  ...
  _computeLeaf_0(participantId_0, share_0, salt_0) {
    return this._persistentHash_0([participantId_0,
                                   ...
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        share_0,
                                                                        'split.compact line 39 char 27')]);
  }
  _deposit_0(context, partialProofData, amount_0, root_0) {
  ...
  _claim_0(context, partialProofData, participantId_0, recipient_0) {
    const pubId_0 = participantId_0;
    __compactRuntime.assert(this._equal_2(recipient_0.bytes, pubId_0),
    ...
    __compactRuntime.assert(this._equal_3(path_0.leaf, leaf_0),
    ...
    let t_1;
    const tmp_0 = (t_1 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   partialProofData,
                                                                                   [
                                                                                    { dup: { n: 0 } },
                                                                                    { idx: { cached: false,
                                                                                    ...
                                                                                    { popeq: { cached: false,
                                                                                               result: undefined } }]).value),
                   (__compactRuntime.assert(t_1 >= share128_0,
